      ...
      <div>
          <div className="testimonials">
              ...
              <div className="test-body">
                  <div className="item">
                      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQA87xVOZwFqe-6hJHJ3QLM-CP5ygzjHhCnOw&usqp=CAU" />
                  ...
                  <div className="item">
                      <img src="https://static.wikia.nocookie.net/genshin-impact/images/b/b6/Персонаж_Чжун_Ли_иконка.png/revision/latest/top-crop/width/150/height/150?cb=20210214184339&path-prefix=ru" />
                          <div className="name">I love anime</div>
                          <small className="design">Student</small>
                  ...
                  <div className="item">
                      <img src="https://static.wikia.nocookie.net/genshin-impact/images/5/5a/Персонаж_Тарталья_иконка.png/revision/latest/top-crop/width/450/height/450?cb=20210214184252&path-prefix=ru" />
                          <div className="name">I love anime</div>
                          <small className="design">Student</small>
